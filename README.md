...
# Installation
We clone the github repository in Google Colaboratory [I'm a reference-style link][Arbitrary case-insensitive reference text]. A hosted jupyter notebook service that allow us to  write and execute arbitrary code through browser.  
