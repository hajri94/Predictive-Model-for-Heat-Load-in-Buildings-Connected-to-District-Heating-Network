...
# Installation
We clone the github repository in Google Colaboratory [I'm an inline-style link](https://www.google.com). A hosted jupyter notebook service that allow us to  write and execute arbitrary code through browser.  
